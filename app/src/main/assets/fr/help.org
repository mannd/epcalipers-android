...
*Compas EP* peut ouvrir des fichiers d'images et des PDF, quel que soit l'endroit où ils se trouvent dans votre appareil.  Il est facile d'ouvrir directement les fichiers joints and les fichiers iCloud, Google Drive, et Dropbox.  Souvent vous pouvez ouvrir un fichier en le tapotant.
...
* Fixer l'image / needs to go in image menu section
